...
def test_data_fetching():
    ...
    from legacy import quant_tool_data as qtd
...
def test_indicators(daily, options):
    ...
    import pandas as pd
    from legacy import quant_tool_indicators as qti
...
def test_feature_completeness():
    ...
    # Check legacy quant_tool_page.py
    legacy_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "legacy", "quant_tool_page.py")
    with io.open(legacy_path, "r", encoding="utf-8") as f:
        content = f.read()
