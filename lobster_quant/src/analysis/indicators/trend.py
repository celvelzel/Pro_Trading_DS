...
class SMAIndicator(Indicator):
    ...
    def calculate(self, data: pd.DataFrame) -> IndicatorResult:
        ...
        return IndicatorResult(name=self.name, values=sma, metadata={"period": period})
...
class EMAIndicator(Indicator):
    ...
    def calculate(self, data: pd.DataFrame) -> IndicatorResult:
        ...
        return IndicatorResult(name=self.name, values=ema, metadata={"period": period})
...
class SlopeIndicator(Indicator):
    ...
    def calculate(self, data: pd.DataFrame) -> IndicatorResult:
        ...
        return IndicatorResult(
            name=self.name, values=slope, metadata={"period": period, "normalized": normalize}
        )
